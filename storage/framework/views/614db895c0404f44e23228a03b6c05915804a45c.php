        ...
        <div class="row justify-content-center mt-5">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="<?php echo e(route('adminList.store')); ?>">
                            <?php echo csrf_field(); ?>
                            <div class="row mb-3">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="row mb-0 d-flex">
                                <div class="col-md-6 offset-md-4 ">
                                    ...
                                    <a href="<?php echo e(route('adminList.index')); ?>" class="btn btn-secondary">Cancel</a>
                                </div>
                            </div>
                        </form>
                    </div>
...
<?php echo $__env->make('backend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Laravel_Talent_Program\sample-app\resources\views/backend/authorization/adminList/create.blade.php ENDPATH**/ ?>